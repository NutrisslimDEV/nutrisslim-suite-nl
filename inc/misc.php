...
function add_to_cart_link() {
    echo '<div id="foocart"><a class="uwcc-open-cart-546612" href="#">Toevoegen aan winkelwagen</a></div>';
}
...
function custom_get_additional_fees_settings() {
    ...
    $additional_fees_settings = array(
        ...
        'priority_delivery' => array(
            'name' => __('Prioritaire levering', 'nutrisslim-suite'),
            'type' => 'number',
        ...
        'package_insurance' => array(
            'name' => __('Verzendverzekering', 'nutrisslim-suite'),
            'type' => 'number',
...
function add_custom_fees_to_cart() {
    ...
    $custom_fees = [
        ...
        'rf_zavarovanje_narocila' => [
            'label' => __('Verzendverzekering', 'nutrisslim-suite'),
        ...
        'rf_priority_delivery' => [
            'label' => __('Prioritaire levering', 'nutrisslim-suite'),
...
<div id="delivery-option" class="rf-custom-option">
    <h3><?php echo __('Kies voor snelle en veilige levering', 'nutrisslim-suite'); ?></h3>
    ...
    <div class="delivery-option rf-option-container" style="<?php echo $is_priority_delivery_bg; ?>">
        <div class="rf-option-left">
            ...
            <label for="rf_priority_delivery">
                <div class="rf-option-title"><?php echo __('Sla de rij over', 'nutrisslim-suite'); ?>
                    (+<?php echo wc_price($priority_delivery); ?>)</div>
                <div class="rf-option-description">
                    <?php echo __('Kies voor prioriteitsverpakking voor de snelste verzending. Door deze optie te kiezen, wordt je bestelling vóór andere bestellingen verwerkt.', 'nutrisslim-suite'); ?>
                </div>
            </label>
        </div>
    ...
    <div class="delivery-option rf-option-container" style="<?php echo $is_checked_zavarovanje_bg; ?>">
        <div class="rf-option-left">
            ...
            <label for="rf_zavarovanje_narocila">
                <div class="rf-option-title"><?php echo __('Pakket verzekering', 'nutrisslim-suite'); ?>
                    (+<?php echo wc_price($package_insurance); ?>)</div>
                <div class="rf-option-description">
                    <?php echo __('Beveilig de levering van het pakket en zorg voor een gegarandeerde en gratis oplossing in geval van beschadigde of ontbrekende producten. Wij sturen het pakket zonder extra kosten.', 'nutrisslim-suite'); ?>
                </div>
            </label>
        </div>
...
<div class="rf-custom-option select-shipping">
    <h3><?php echo __('Levering', 'woocommmerce'); ?></h3>
...
function custom_woocommerce_loop_add_to_cart_link($html, $product) {
    ...
    $custom_text = __( 'Voeg toe aan winkelwagen', 'woocommerce' );
...
function cart_upsell() {
    ...
    if (!empty($items)) {
        ...
        $output .= '<h3>' . __('Speciale aanbieding alleen hier!', 'nutrisslim-suite') . '</h3>';
        $output .= '<p>' . __('Voeg toe om te bestellen en te besparen!.', 'nutrisslim-suite') . '</p>';
        ...
        foreach ($items as $item) {
            ...
            $output .= '<button class="cart-button_swiper add-to-cart-icon" data-offer="cart_upsell" data-product-id="' . $pid . '" data-quantity="1" data-price="' . $offer_price . '" ' . $disabled . '>' . __('Toevoegen aan winkelwagen', 'woocommerce') . '</button>';
...
function add_meta_to_order_fees($item, $fee_key, $fee, $order) {
    ...
    $fee_sifrant_map = array(
        ...
        'prioritaire-levering' => get_option('priority_delivery_fee_sifrant'),
        'eco-friendly-packaging' => get_option('custom_eco_friendly_packaging_sifrant'),
        'verzendverzekering' => get_option('custom_package_insurance_sifrant'),
    );
