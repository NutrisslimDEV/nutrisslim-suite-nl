    ...
    function filter_submit_review_page_content( string $content ): string {
        ...
        <div class="mass-reviews container container-px">
            <div class="review-intro">
                <h1 class="bold"><?php echo esc_html__('Jouw mening is belangrijk voor ons', 'nutrisslim-suite'); ?></h1>
                <p><?php echo esc_html__('Bij Nature\'s Finest streven we er altijd naar om de beste producten en diensten te leveren aan onze gewaardeerde klanten. Wil je je laatste aankoop beoordelen?', 'nutrisslim-suite'); ?></p>
                <p><?php echo esc_html__('Als dank voor je tijd sturen we een speciaal cadeautje mee met je bestelling!', 'nutrisslim-suite'); ?></p>

                <h4><?php echo esc_html__('Je bestelling', 'woocommerce'); ?></h4>
                ...
                <h4><?php echo esc_html__('Beoordeel en recenseer je aankoop', 'nutrisslim-suite'); ?></h4>
            </div>
            ...
            <div class="form">
                <div class="nf-review_form">
                    <div class="review_fields">
                        ...
                        <textarea name="review_review" id="review_text" cols="30" rows="5" placeholder="<?php echo esc_attr__('Vertel ons wat je vindt','nutrisslim-suite'); ?>"></textarea>
                        <button id="send_reviews"><?php echo esc_html__('Verzenden','woocommerce'); ?></button>
                    </div>
                </div>
            </div>
        </div>
